...
const BUYER_STEPS = [
  ...
  { id: 4, title: "Business verification" },
  { id: 5, title: "Password" },
];

export const BuyerOnboarding: React.FC = () => {
  const currentStep = 1; // Fixed value for now
  const [email, setEmail] = React.useState("");

  const handleNext = () => {
    console.log("Moving to next step with email:", email);
    // TODO: Navigate to step 2 or call API
  };
  ...
  return (
    <OnboardingLayout currentStep={currentStep} steps={BUYER_STEPS}>
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-gray-500">
              We use the same email you're using at work
            </p>
          </div>
